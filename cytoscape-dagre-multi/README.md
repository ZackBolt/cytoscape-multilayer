 ...
 * via bower: `bower install cytoscape-dagre-multi`, or
...
1. If publishing to bower for the first time, you'll need to run `bower register cytoscape-dagre-multi https://github.com/cytoscape/cytoscape.js-dagre-multi.git`
1. [Make a new release](https://github.com/cytoscape/cytoscape.js-dagre-multi/releases/new) for Zenodo.
